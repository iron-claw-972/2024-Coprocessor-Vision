...
def main():
	...
	model_name = "/home/ironclaw/MoreVision/2024-Coprocessor-Vision/edgetpu-yolo/yolov5s-int8-96_edgetpu.tflite"#input("Model File (Weights in Tflite):")
	...
	model = EdgeTPUModel(model_name, names_yaml, conf_thresh=0.4, iou_thresh=0.45)
	...
	while True:
		...
		resimage = model.process_predictions(pred[0], image, pad)
